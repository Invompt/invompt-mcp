...
> **Prefer the hosted connector:** [`com.invompt/invompt`](https://glama.ai/mcp/connectors/com.invompt/invompt) → `https://mcp.invompt.com/mcp` · Continue anonymously · review-before-send.
>
> This repo’s local-beta / stdio package (Claude Code / Codex) is secondary. Do **not** treat Deploy Server or API-key as the primary path for new users. Official Registry: `com.invompt/invompt` (LIVE).
