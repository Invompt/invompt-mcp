...
const expectedAnnotations: Record<string, RequiredAnnotations> = {
  ...
  list_invoice_templates: { readOnlyHint: true, destructiveHint: false, openWorldHint: false },
  get_invoice_template: { readOnlyHint: true, destructiveHint: false, openWorldHint: false },
  preview_invoice_template_extraction: { readOnlyHint: true, destructiveHint: false, openWorldHint: false },
