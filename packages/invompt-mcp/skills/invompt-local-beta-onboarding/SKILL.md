...
- Claude Code: `npx --yes invompt-mcp@0.11.7 status --json`
- Codex: `npx --yes invompt-mcp@0.11.7 status --json`
...
| Host | Guest | OAuth |
|---|---|---|
| Claude Code | `npx --yes invompt-mcp@0.11.7 setup --host claude-code --mode guest` | `npx --yes invompt-mcp@0.11.7 setup --host claude-code --mode oauth` |
| Codex | `npx --yes invompt-mcp@0.11.7 setup --host codex --mode guest` | `npx --yes invompt-mcp@0.11.7 setup --host codex --mode oauth` |
